...
app.on('message', async ({ send, stream, activity }) => {
    ...
    try {
        const prompt = new teams_ai_1.ChatPrompt({
            messages,
            instructions,
            model: new unified_chat_model_1.UnifiedChatModel((0, language_model_1.getLanguageModel)(config_1.default.llmProvider, config_1.default.llmModelName || '', config_1.default.llmApiKey || '')),
        });
        let responseContent = '';
